...
public class Library {
	...
	public List<ReadingMaterial> catalogOfBooks(){
		...
		for(String subject : materials.get(ReadingType.TEXTBOOK).keySet()){
			list.addAll(materials.get(ReadingType.TEXTBOOK).get(subject));
		}
		return list;
	}
	...
	public List<ReadingMaterial> catalogOfTextBooks(){
		List<ReadingMaterial> list = new ArrayList<ReadingMaterial>();
		for(String subject : materials.get(ReadingType.BOOK).keySet()){
			list.addAll(materials.get(ReadingType.BOOK).get(subject));
		}
		return list;
	}
}
